...
class dcm20Parser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'\n'", "'KONSERVIERUNG_FORMAT'", "'2.0'", 
                     "'MODULKOPF'", "'FUNKTIONEN'", "'END'", "'FKT'", "'VARIANTENKODIERUNG'", 
                     "'KRITERIUM'", "'FESTWERT'", "'WERT'", "'TEXT'", "'FESTWERTEBLOCK'", 
                     ...
                     "'ST/Y'", "'ST_TX/Y'", "<INVALID>", "<INVALID>", "<INVALID>", 
                     "<INVALID>", "'-'" ]
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "<INVALID>", "<INVALID>", "NAME", "TEXT", 
    ...
    ruleNames =  [ "konservierung", "kons_kopf", "modulkopf_info", "mod_zeile", 
                   "mod_anf_zeile", "mod_fort_zeile", "mod_ele_name", "mod_ele_wert", 
                   "funktionsdef", "funktionszeile", "fkt_version", "fkt_langname", 
                   "variantendef", "variantenkrit", "krit_name", "krit_wert", 
                   "kons_rumpf", "kenngroesse", "kennwert", "kennwerteblock", 
                   "kennlinie", "kennfeld", "gruppenstuetzstellen", "kenntext", 
                   "kgr_info", "einheit_x", "einheit_y", "einheit_w", "langname", 
                   "displayname", "var_abhangigkeiten", "var_abh", "funktionszugehorigkeit", 
                   "anzahl_x", "anzahl_y", "werteliste", "werteliste_kwb", 
                   "sst_liste_x", "kf_zeile_liste", "kf_zeile_liste_r", 
                   "kf_zeile_liste_tx", "realzahl", "nameValue", "textValue", 
                   "integerValue" ]
    ...
    def kons_rumpf(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << dcm20Parser.T__9) | (1 << dcm20Parser.T__12) | (1 << dcm20Parser.T__13) | (1 << dcm20Parser.T__14) | (1 << dcm20Parser.T__15) | (1 << dcm20Parser.T__16) | (1 << dcm20Parser.T__17) | (1 << dcm20Parser.T__18) | (1 << dcm20Parser.T__19) | (1 << dcm20Parser.T__20))) != 0):
                self.state = 198
    ...
    def kennlinie(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << dcm20Parser.T__13) | (1 << dcm20Parser.T__14) | (1 << dcm20Parser.T__15))) != 0)):
    ...
    def kennfeld(self):
        ...
        try:
            ...
            localctx.cat = self._input.LT(1)
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << dcm20Parser.T__16) | (1 << dcm20Parser.T__17) | (1 << dcm20Parser.T__18))) != 0)):
                localctx.cat = self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
