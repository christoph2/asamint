...
class AxisXPoint(Base):
    ...
    __mapper_args__ = {
        "polymorphic_identity": "AxisXPoint"
    }
...
class AxisYPoint(Base):
    ...
    __mapper_args__ = {
        "polymorphic_identity": "AxisYPoint"
    }
...
class AxisZPoint(Base):
    ...
    __mapper_args__ = {
        "polymorphic_identity": "AxisZPoint"
    }
...
class Axis4Point(Base):
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Axis4Point"
    }
...
class Axis5Point(Base):
    ...
    __mapper_args__ = {
        "polymorphic_identity": "Axis5Point"
    }
...
class NDimContainer(HasValues, BaseCharacteristic):
    ...
    __mapper_args__ = {
        "polymorphic_identity": "NDimContainer"
    }
