...
class Calibration:
    ...
    def save_ascii(self, characteristic_name: str, value: str, readOnlyPolicy: ExecutionPolicy = ExecutionPolicy.EXCEPT) -> Status:
    ...
    def save_value_block(
        self, characteristic_name: str, values: np.ndarray, readOnlyPolicy: ExecutionPolicy = ExecutionPolicy.EXCEPT
    ) -> Status:
