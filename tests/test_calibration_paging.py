...
def _make_calibration_data(tmp_path: Path) -> calibration_module.CalibrationData:
    ...
    instance.epk = SimpleNamespace(check_epk_xcp=lambda xcp_master: None)

    def check_epk_xcp(xcp_master: Any) -> Any:
        return instance.epk.check_epk_xcp(xcp_master)

    instance.check_epk_xcp = check_epk_xcp
    return instance
